...
export default function HeroSection() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.from(".hero-logo",    { opacity: 0, y: 16,  duration: 0.6 })
        ...
        .from(".hero-card",    { opacity: 0, x: 24,  duration: 0.8,
                                 ease: "power2.out"                  }, "-=0.6");
  ...
  return (
    <section id="hero-section" className="relative bg-black" style={{ minHeight: "220vh" }}>
      ...
      <div className="sticky top-0 h-screen overflow-hidden">
        ...
        <div ref={textRef} className="relative z-10 w-full max-w-7xl mx-auto px-8 h-full flex items-center">
          <div className="max-w-[46%]">
            ...
            <div className="hero-logo mb-7">
              <svg viewBox="0 0 814 1000" width="26" height="32" aria-hidden="true"
            ...
            {/* Eyebrow */}
            <p className="hero-eyebrow font-syne text-[10px] font-semibold text-apple-blue uppercase tracking-[0.32em] mb-5">
            ...
            <div className="hero-ctas flex flex-wrap gap-3">
              ...
              <Link href="/about"
                className="inline-flex items-center gap-2.5 border border-white/20 text-white text-[11px] font-semibold uppercase tracking-widest px-7 py-3.5 hover:border-white/50 active:scale-[0.97] transition-all duration-150 font-syne">
                Our Story
              </Link>
            </div>
          ...
          <div style={{
            ...
            <div className="flex items-center gap-2 mb-5">
              <span className="font-syne text-[9px] font-bold uppercase tracking-widest px-2.5 py-0.5 rounded-full"
                style={{ background: "rgba(0,113,227,0.75)", color: "#fff" }}>
                New
              </span>
            ...
            <div className="font-bebas text-white text-[28px] leading-none mb-5">
              Nu. 1,59,900
            </div>
        ...
        {/* ── Scroll hint ─────────────────────────────────────────────────────── */}
        <div ref={hintsRef} className="hero-hints absolute bottom-8 left-8 z-10 flex items-center gap-3">
