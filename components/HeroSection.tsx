      ...
      <div className="sticky top-0 h-screen overflow-hidden">
        ...
        >
          <div className="w-full max-w-[90%] sm:max-w-[75%] lg:max-w-[46%]">
            ...
            {/* Apple icon */}
            <div className="hero-logo mb-4 sm:mb-5 md:mb-7 flex justify-center md:justify-start">
            ...
            {/* Eyebrow */}
            <p className="hero-eyebrow font-syne text-[10px] font-semibold text-apple-blue uppercase tracking-[0.32em] mb-3 sm:mb-5">
              Bhutan&apos;s #1 Apple Authorised Store
            </p>

            {/* Headline */}
            <h1 className="hero-h1 font-bebas leading-[0.90] mb-5 sm:mb-8"
            ...
            {/* Pills */}
            <div className="hero-pills flex flex-wrap gap-2 mb-5 sm:mb-8 justify-center md:justify-start">
              {["Genuine Devices", "Expert Service", "Nationwide Delivery"].map((label) => (
                <span key={label}
                  className="font-syne text-[9px] sm:text-[10px] text-white/50 border border-white/12 px-3 py-1.5 rounded-full tracking-wide">
                  {label}
                </span>
              ))}
            </div>
